const CACHE = 'athome-carcare-v83';
const ASSETS = [
  './', './index.html', './styles.css?v=20260916-1line', './home-polish.css?v=20260916-nohero1', './restore-classic.js?v=20260916-2', './compat-fix.js?v=20260916-3', './app.js?v=20260926-interior1', './supabase-integration.js?v=20260924-galdel1', './manifest.webmanifest?v=20260919-icon5', './data/content.json',
