const CACHE = 'athome-carcare-v72';
const ASSETS = [
  './', './index.html', './styles.css?v=20260916-1line', './home-polish.css?v=20260916-nohero1', './restore-classic.js?v=20260916-2', './compat-fix.js?v=20260916-3', './app.js?v=20260922-gallery1', './supabase-integration.js?v=20260921-stats1', './manifest.webmanifest?v=20260919-icon5', './data/content.json',
