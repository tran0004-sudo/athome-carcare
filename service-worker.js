const CACHE = 'athome-carcare-v55';
const ASSETS = [
  './', './index.html', './styles.css?v=20260916-1line', './home-polish.css?v=20260916-nohero1', './restore-classic.js?v=20260916-2', './compat-fix.js?v=20260916-3', './app.js?v=20260917-plate', './supabase-integration.js?v=20260916-adminfix', './manifest.webmanifest?v=20260919-icon4', './data/content.json',
  './icons/icon.svg', './icons/icon-192.png?v=20260919-icon4', './icons/icon-512.png?v=20260919-icon4', './icons/icon-maskable-512.png?v=20260919-icon4',
...
async function withSupabaseIntegration(response) {
  ...
  html = html
    .replaceAll('manifest.webmanifest?v=20260915-7', 'manifest.webmanifest?v=20260919-icon4')
    .replaceAll('icons/icon.svg?v=20260915-7', 'icons/icon-192.png?v=20260919-icon4');
