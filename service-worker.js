const CACHE = 'athome-carcare-v68';
const ASSETS = [
  './', './index.html', './styles.css?v=20260916-1line', './home-polish.css?v=20260916-nohero1', './restore-classic.js?v=20260916-2', './compat-fix.js?v=20260916-3', './app.js?v=20260920-optsize2', './supabase-integration.js?v=20260921-vapid2', './manifest.webmanifest?v=20260919-icon5', './data/content.json',
