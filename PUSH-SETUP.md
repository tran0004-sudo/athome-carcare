...
| 이름 | 값 |
|---|---|
| `VAPID_PUBLIC_KEY` | `BM4LZJ-Jr98hfBk0LMrTF4sf2GGiCbrILKTaJLFFsdrGqpEjwtUGb987ihqhy6dsANynnnVBXIkYmrcYujALEdU` |
| `VAPID_PRIVATE_KEY` | 이 대화에서 전달받은 새 비공개키 — **Supabase Secrets에만 입력** |
